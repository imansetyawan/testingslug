...
class KategoriController extends Controller
{
    ...
    public function create()
    {
        ...
        $kategori = Kategori::all(); 
        return view ('kategori.insertkategori', ['indukkategori' => $indukkategori, 'kategori' => $kategori]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('kategori.editkategori', ['kategori' => $kategori, 'kategoris' => $kategoris]) ;
    }
