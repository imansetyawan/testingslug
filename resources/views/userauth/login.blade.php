...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <div class="social-auth-links text-center">
      <p>- OR -</p>
      <a href="{{route('get_auth_facebook')}}" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-facebook"></i> Sign in using
        Facebook</a>
      <a href="{{route('get_auth_google')}}" class="btn btn-block btn-social btn-google btn-flat"><i class="fa fa-google-plus"></i> Sign in using
        Google+</a>
    </div>
    <!-- /.social-auth-links -->

    <a href="{{route('get_forgot_pass')}}">I forgot my password</a><br>
