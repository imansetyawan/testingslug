                    ...
                    <div class="col-md-6">
                        ...
                        <article class="post post-grid">
                            <div class="post-thumb">
                                ...
                                <a href="{{route('single_artikel', ['slug' => $row->slug])}}" class="post-thumb-overlay text-center">
                                    <div class="text-uppercase text-center">View Post</div>
                                </a>
                            </div>
                            <div class="post-content">
                                <header class="entry-header text-center text-uppercase">
                                    <h6><a href="{{ route('get_kategori_artikel', ['id' => $row->kategori_id])}}"> {{$row->kategori->namakategori}}</a></h6>

                                    <h1 class="entry-title"><a href="{{route('single_artikel', ['slug' => $row->slug])}}">{{$row->judulartikel}}</a></h1>
                                </header>
